        ...
        <div class="page-content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-warning" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" data-bs-toggle="tab" href="#infoPosyandu" role="tab"
                                aria-selected="true">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#dataPosyandu" role="tab"
                                aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bxs-data font-18 me-1'></i></div>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#dataPeralatan" role="tab"
                                aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bxs-data font-18 me-1'></i></div>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#dataPerbekalan" role="tab"
                                aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bxs-data font-18 me-1'></i></div>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#dataInstrumen" role="tab"
                                aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bxs-data font-18 me-1'></i></div>
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#dataSasaran" role="tab"
                                aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon"><i class='bx bxs-data font-18 me-1'></i></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($dataPosyandu->sk_kelurahan)
                                                    <a href="{{ asset($dataPosyandu->sk_kelurahan) }}"
                                                        target="_blank">Lihat SK Kelurahan</a>
                                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($dataPosyandu->foto_lokasi)
                                                    <a href="{{ asset($dataPosyandu->foto_lokasi) }}"
                                                        target="_blank">Lihat Foto Lokasi</a>
                                                @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($peralatan && $peralatan->gambar)
                                                        <img src="{{ asset('uploads/gambar_peralatankes/' . $peralatan->gambar) }}"
                                                            alt="{{ $peralatan->nama }}" width="100">
                                                    @else
                                                        Tidak ada gambar
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($perbekalan && $perbekalan->gambar)
                                                        <img src="{{ asset('uploads/gambar_perbekalankes/' . $perbekalan->gambar) }}"
                                                            alt="{{ $perbekalan->nama }}" width="100">
                                                    @else
                                                        Tidak ada gambar
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($instrumen && $instrumen->gambar)
                                                        <img src="{{ asset('uploads/gambar_instrumen/' . $instrumen->gambar) }}"
                                                            alt="{{ $instrumen->nama }}" width="100">
                                                    @else
                                                        Tidak ada gambar
                                                    @endif
                                                </td>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        <h6 class="mb-0 text-dark">Warning </h6>
                                                        <div class="text-dark">Tidak ada data instrumen kesehatan tersedia.
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="dataSasaran" role="tabpanel">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    @if ($dataSasaran)
                                        <tr>
                                            <th scope="row">Jumlah Bayi 0-1</th>
                                            <td>{{ $dataSasaran->jumlah_bayi_1 }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Jumlah Bayi 0-2</th>
                                            <td>{{ $dataSasaran->jumlah_bayi_2 }}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Jumlah Balita 1-5</th>
                                        ...
                                        <tr>
                                            <th scope="row">Jumlah Anak Usia Sekolah 6-18</th>
                                            <td>{{ $dataSasaran->jumlah_anak_usia_sekolah }}</td>
                                            <!-- Tambahkan jika diperlukan -->
                                        </tr>
                                        <tr>
                                            <th scope="row">Jumlah Usia Dewasa</th>
                                            <td>{{ $dataSasaran->jumlah_usia_dewasa }}</td>
                                            <!-- Tambahkan jika diperlukan -->
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        <h6 class="mb-0 text-dark">Warning </h6>
                                                        <div class="text-dark">Tidak ada data sasaran Posyandu tersedia.
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                ...
                <div class="card-header">
                    <a href="/daftarposyandu" class="btn btn-sm btn-warning">Kembali</a>
                </div>
            </div>
        </div>
    </div>
