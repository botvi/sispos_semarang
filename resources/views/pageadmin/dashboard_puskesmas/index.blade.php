                    ...
                    <div class="alert alert-info border-0 bg-info alert-dismissible fade show py-2">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <div class="text-dark">Ini Merupakan Akumulasi Seluruh Data Posyandu Di Lingkup Puskesmas
                                    Anda</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @forelse ($kelurahanCounts as $kelurahan)
                                        <tr>
                                            <td>{{ $kelurahan->kelurahan_name }}</td>
                                            <td>{{ $kelurahan->count }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="2">Tidak ada Posyandu</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
