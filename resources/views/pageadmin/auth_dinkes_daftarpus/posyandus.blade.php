...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="/daftarpuskesmas" class="btn btn-danger">Kembali</a>
                </div>
            </div>
        </div>
        <!-- End Breadcrumb -->
                    ...
                    <div class="col mb-4">
                        <div class="card d-flex flex-column h-100">
                            ...
                            <div class="card-body flex-grow-1 d-flex flex-column">
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('daftarposyandubypuskes.detail', $posyandu->user_id) }}" class="btn btn-warning my-2 radius-30">Detail Posyandu</a>
                                </div>
                            </div>
                        </div>
                    </div>
                @empty
                    <p>Tidak ada Posyandu yang terdaftar untuk Puskesmas ini.</p>
                @endforelse
            </div>
        </div>
    </div>
