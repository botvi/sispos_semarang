...
class DashboardPosyanduController extends Controller
{
    public function index()
    {
        // Ambil data grafik per bulan untuk semua kategori
        $dataPerBulanAnakRemaja = BulananAnakDanRemaja::where('user_id', Auth::id())
            ->selectRaw('
        ...
        $dataPerBulanBalita = BulananBalita::where('user_id', Auth::id())
            ->selectRaw('
                MONTH(tanggal_pelaksanaan) as month, 
                YEAR(tanggal_pelaksanaan) as year,
        ...
        $dataPerBulanDewasaLansia = BulananDewasaDanLansia::where('user_id', Auth::id())
            ->selectRaw('
                MONTH(tanggal_pelaksanaan) as month, 
                YEAR(tanggal_pelaksanaan) as year,
        ...
        $dataPerBulanIbuHamil = BulananIbuHamil::where('user_id', Auth::id())
            ->selectRaw('
                MONTH(tanggal_pelaksanaan) as month, 
                YEAR(tanggal_pelaksanaan) as year,
        ...
        return view('pageadmin.dashboard_posyandu.index', [
            'months' => $months,
